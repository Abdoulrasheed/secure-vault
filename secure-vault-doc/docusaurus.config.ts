...
const config: Config = {
  ...
  themeConfig: {
    ...
    footer: {
          ...
          items: [
            {
              ...
              href: 'https://stackoverflow.com/questions/tagged/securevault',
            },
            {
              label: 'Discord',
              href: 'https://discordapp.com/invite/securevault',
            },
            {
              label: 'X',
              href: 'https://x.com/securevault',
            },
          ],
        },
        {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} SecureVault.`,
    },
    prism: {
